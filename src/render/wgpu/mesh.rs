...
impl RenderMesh {
    ...
    pub fn from_shape(device: &wgpu::Device, _queue: &wgpu::Queue, shape: &Shape) -> Option<RenderMesh> {
        ...
        if let Some(mesh_data) = create_mesh_data(shape) {
            ...
            let vertex_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
                ...
                contents: bytemuck::cast_slice::<RenderVertex, u8>(&vertex_data),
            ...
            let index_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
                ...
                contents: bytemuck::cast_slice::<u32, u8>(&index_data),
